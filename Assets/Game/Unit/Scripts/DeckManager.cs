...
public class DeckManager
{
    ...
    public bool DrawCard()
    {
        ...
        if (DrawPile.Count > 0)
        {
            ...
            GameController.Instance.UIController.UnitDataPanel.CardSlots[0].UIData.SetAbility(card);
    ...
    public void MoveCard()
    {
        ...
        {
            Hand[i] = Hand[i - 1];
            GameController.Instance.UIController.UnitDataPanel.CardSlots[i].UIData.SetAbility(Hand[i]);
        }

        Hand[0] = AbilityHolder.AbilityType.None;
        GameController.Instance.UIController.UnitDataPanel.CardSlots[0].UIData.SetAbility(Hand[0]);
    }
    ...
    public void DiscardCard(int index)
    {
        ...
        GameController.Instance.UIController.UnitDataPanel.CardSlots[index].UIData.SetAbility(AbilityHolder.AbilityType.None);
    }
